<div class="container py-5">
 <div class="custom-container custom-center">
    ...
    <div class="text-center mt-3">
        ...
        <div class="text-center mt-3">
            <a href="<?php echo base_url('admin/companies') ?>" class="btn btn-lg rounded-0  btn-color full-width">Companies</a>
        </div>
        <div class="text-center mt-3">
            <a href="<?php echo base_url('admin/users') ?>" class="btn btn-lg rounded-0  btn-color full-width">Users</a>
        </div>
    </div>
    </div>
</div>